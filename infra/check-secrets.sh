...
echo ""
echo "  AZURE_OPENAI_IMAGE_API_KEY / AZURE_OPENAI_IMAGE_ENDPOINT"
echo "    → Azure Portal → your GPT Image Foundry resource → Keys and Endpoint"
echo ""
echo "  AZURE_OPENAI_IMAGE_DEPLOYMENT"
echo "    → The deployment name for your GPT Image model (defaults to gpt-image-1)"
echo ""
echo "  AI_PROVIDER"
echo "    → 'openai' or 'azure' (controls which AI backend is used for image generation)"
echo ""
echo "  OPENAI_API_KEY"
echo "    → OpenAI Platform → API keys → Create new secret key"
echo ""
